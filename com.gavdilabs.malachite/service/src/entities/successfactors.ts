...
export type ActionGetWorkflowPendingDataReturn = IWfRequestPendingDataResponse[];
...
export type FuncCreatePerformanceReviewFormReturn = ICreatePerformanceReviewFormResponse;
...
export type FuncGetMatchedGuideLineRuleInfoReturn = IGetMatchedGuideLineRuleInfoResponse;
...
export type FuncIsUserEligibleForSpotAwardProgramReturn = IIsUserEligibleForSpotAwardProgramResponse;
...
export type FuncGetEligibleSpotAwardsProgramCodesReturn = IGetEligibleSpotAwardsProgramCodesResponse;
...
export enum Entity {
    Map_entry_string_string_ = "successfactors.map_entry_string_string_",
    Localstring = "successfactors.localstring",
    Type = "successfactors.Type",
    Multiplicity = "successfactors.multiplicity",
    Association_end = "successfactors.association_end",
    Association = "successfactors.association",
    Navigation = "successfactors.navigation",
    Property = "successfactors.property",
    RuleFieldMappingBean = "successfactors.RuleFieldMappingBean",
    RuleFieldMappingBeanList = "successfactors.RuleFieldMappingBeanList",
    ThemeUrlsBean = "successfactors.ThemeUrlsBean",
    ThemeFingerprintsBean = "successfactors.ThemeFingerprintsBean",
    AccessibilityPreferences = "successfactors.AccessibilityPreferences",
    ThemeColor = "successfactors.ThemeColor",
    ThemeURL = "successfactors.ThemeURL",
    ThemeBackgroundConfig = "successfactors.ThemeBackgroundConfig",
    ThemeButtonConfig = "successfactors.ThemeButtonConfig",
    ThemeCardConfig = "successfactors.ThemeCardConfig",
    ThemeContentConfig = "successfactors.ThemeContentConfig",
    ThemeDiagramConfig = "successfactors.ThemeDiagramConfig",
    ThemeExternalConfig = "successfactors.ThemeExternalConfig",
    ThemeFooterConfig = "successfactors.ThemeFooterConfig",
    ThemeHeaderBackgroundConfig = "successfactors.ThemeHeaderBackgroundConfig",
    ThemeHighlightConfig = "successfactors.ThemeHighlightConfig",
    ThemeHomepageConfig = "successfactors.ThemeHomepageConfig",
    ThemeLoginBackgroundConfig = "successfactors.ThemeLoginBackgroundConfig",
    ThemeLoginLogoConfig = "successfactors.ThemeLoginLogoConfig",
    ThemeLoginConfig = "successfactors.ThemeLoginConfig",
    ThemeLogoConfig = "successfactors.ThemeLogoConfig",
    ThemeMenuConfig = "successfactors.ThemeMenuConfig",
    ThemeModulePickerConfig = "successfactors.ThemeModulePickerConfig",
    ThemeNavigationConfig = "successfactors.ThemeNavigationConfig",
    ThemePlacematConfig = "successfactors.ThemePlacematConfig",
    ThemePortletConfig = "successfactors.ThemePortletConfig",
    ThemeTableConfig = "successfactors.ThemeTableConfig",
    ThemeTileConfig = "successfactors.ThemeTileConfig",
    ThemeLandingPageConfig = "successfactors.ThemeLandingPageConfig",
    ThemeLandingPageTileConfig = "successfactors.ThemeLandingPageTileConfig",
    GlobalThemeConfiguration = "successfactors.GlobalThemeConfiguration",
    GetBizXActionResponse = "successfactors.GetBizXActionResponse",
    GenerateNextPersonIDResponse = "successfactors.GenerateNextPersonIDResponse",
    WfRequestActionResponse = "successfactors.WfRequestActionResponse",
    ChangeDataBean = "successfactors.ChangeDataBean",
    PendingDataAttributeBean = "successfactors.PendingDataAttributeBean",
    EssMssWorkflowAttributeBean = "successfactors.EssMssWorkflowAttributeBean",
    EssMssWorkflowSubAttributeBean = "successfactors.EssMssWorkflowSubAttributeBean",
    PendDataInlineGroupBean = "successfactors.PendDataInlineGroupBean",
    PendDataGroupBean = "successfactors.PendDataGroupBean",
    EssMssWorkflowAttributeGroupBean = "successfactors.EssMssWorkflowAttributeGroupBean",
    WfRequestPendingDataResponse = "successfactors.WfRequestPendingDataResponse",
    Map_entry_string_ComplianceDataVO_ = "successfactors.map_entry_string_ComplianceDataVO_",
    DocumentCategoryDetails = "successfactors.DocumentCategoryDetails",
    DocumentCategories = "successfactors.DocumentCategories",
    COSocialAccountBean = "successfactors.COSocialAccountBean",
    COUserInfoElementBean = "successfactors.COUserInfoElementBean",
    PeopleProfileHeaderResponse = "successfactors.PeopleProfileHeaderResponse",
    EPCustomBackgroundPortletProperty = "successfactors.EPCustomBackgroundPortletProperty",
    InviteToApplyResponse = "successfactors.InviteToApplyResponse",
    Map_entry_string_AgencyLocaleDetails_ = "successfactors.map_entry_string_AgencyLocaleDetails_",
    CORouteFormStatusBean = "successfactors.CORouteFormStatusBean",
    CreatePerformanceReviewFormResponse = "successfactors.CreatePerformanceReviewFormResponse",
    ToDoEntry = "successfactors.ToDoEntry",
    ToDoBean = "successfactors.ToDoBean",
    GetMatchedGuideLineRuleInfoResponse = "successfactors.GetMatchedGuideLineRuleInfoResponse",
    IsUserEligibleForSpotAwardProgramResponse = "successfactors.IsUserEligibleForSpotAwardProgramResponse",
    GetEligibleSpotAwardsProgramCodesResponse = "successfactors.GetEligibleSpotAwardsProgramCodesResponse",
    ONB2RehireCheckParams = "successfactors.ONB2RehireCheckParams",
    ONB2OnboardeeDetails = "successfactors.ONB2OnboardeeDetails",
    ONB2ExternalHRISHiringUpdate = "successfactors.ONB2ExternalHRISHiringUpdate",
    Map_entry_string_HomepageTile_ = "successfactors.map_entry_string_HomepageTile_",
    NominationApprovalWorkflowResponse = "successfactors.NominationApprovalWorkflowResponse",
    Map_entry_string_bool_ = "successfactors.map_entry_string_bool_",
    SEFEventEntityKey = "successfactors.SEFEventEntityKey",
    SEFEventEntityParam = "successfactors.SEFEventEntityParam",
    SEFExtEventMetaData = "successfactors.SEFExtEventMetaData",
    SEFExtEventMetaDataList = "successfactors.SEFExtEventMetaDataList",
    Map_entry_string_SEFSubscriberConfigurationPerCategory_ = "successfactors.map_entry_string_SEFSubscriberConfigurationPerCategory_",
    Map_entry_ISCRetryFlowMetaData_ISCRetryFlowStatusMetaData_ = "successfactors.map_entry_ISCRetryFlowMetaData_ISCRetryFlowStatusMetaData_",
    SPMetadataGenerator = "successfactors.SPMetadataGenerator",
    DynamicGroupBean = "successfactors.DynamicGroupBean",
    DynamicGroupUserBean = "successfactors.DynamicGroupUserBean",
    Map_entry_string_property_ = "successfactors.map_entry_string_property_",
    Map_entry_string_navigation_ = "successfactors.map_entry_string_navigation_",
    Entity = "successfactors.Entity",
    JobReqTemplate_Hiring_Requisition_Manual = "successfactors.JobReqTemplate_Hiring_Requisition_Manual",
    PaymentInformationDetailV3MWI = "successfactors.PaymentInformationDetailV3MWI",
    TimeTypeCAN = "successfactors.TimeTypeCAN",
    Goal_101 = "successfactors.Goal_101",
    JobRequisitionPostingFieldControls = "successfactors.JobRequisitionPostingFieldControls",
    JobRequisitionLocale = "successfactors.JobRequisitionLocale",
    GoalPermission_101 = "successfactors.GoalPermission_101",
    FormRatingScaleValue = "successfactors.FormRatingScaleValue",
    EmpEmploymentTermination = "successfactors.EmpEmploymentTermination",
    InnerMessage = "successfactors.InnerMessage",
    JobApplicationStatusLabel = "successfactors.JobApplicationStatusLabel",
    Cust_CC_AppConfig = "successfactors.cust_CC_AppConfig",
    SelfReportSkillMapping = "successfactors.SelfReportSkillMapping",
    SpotAwardProgramAdvancedSettings = "successfactors.SpotAwardProgramAdvancedSettings",
    Cust_CC_Note = "successfactors.cust_CC_Note",
    Cust_CC_ProfileTask = "successfactors.cust_CC_ProfileTask",
    TodoAction = "successfactors.TodoAction",
    SpotAward = "successfactors.SpotAward",
    UpsertResult = "successfactors.UpsertResult",
    CompanyProvisioner = "successfactors.CompanyProvisioner",
    InterviewOverallAssessment = "successfactors.InterviewOverallAssessment",
    SimpleDevGoal = "successfactors.SimpleDevGoal",
    ExternalLearnerPhoneInfo = "successfactors.ExternalLearnerPhoneInfo",
    EmployeeProfileBlockLink = "successfactors.EmployeeProfileBlockLink",
    GoalDetail = "successfactors.GoalDetail",
    LegalEntityARG = "successfactors.LegalEntityARG",
    EmployeeProfileSectionConfig = "successfactors.EmployeeProfileSectionConfig",
    PayScalePayComponent = "successfactors.PayScalePayComponent",
    Background_InsideWorkExperience = "successfactors.Background_InsideWorkExperience",
    CalibrationSessionSubject = "successfactors.CalibrationSessionSubject",
    PicklistLabel = "successfactors.PicklistLabel",
    TimeZone = "successfactors.TimeZone",
    EmployeeProfileBlockContent = "successfactors.EmployeeProfileBlockContent",
    TrendData_SysOverallPotential = "successfactors.TrendData_SysOverallPotential",
    GoalEnum = "successfactors.GoalEnum",
    DevLearningCertifications = "successfactors.DevLearningCertifications",
    PaymentInformationDetailV3JPN = "successfactors.PaymentInformationDetailV3JPN",
    PhysicalReqContent = "successfactors.PhysicalReqContent",
    OneTimeDeduction = "successfactors.OneTimeDeduction",
    TimeAccountType = "successfactors.TimeAccountType",
    DevGoal_2006 = "successfactors.DevGoal_2006",
    Todo = "successfactors.Todo",
    CalibrationSessionReviewer = "successfactors.CalibrationSessionReviewer",
    FOWfConfigStepApprover = "successfactors.FOWfConfigStepApprover",
    ExtEmailInfo = "successfactors.ExtEmailInfo",
    Cust_GER_Template = "successfactors.cust_GER_Template",
    PayrollConfigurationCategory = "successfactors.PayrollConfigurationCategory",
    ExternalLearnerPersonalInfo = "successfactors.ExternalLearnerPersonalInfo",
    DevGoal_2007 = "successfactors.DevGoal_2007",
    JobRequisitionPosting = "successfactors.JobRequisitionPosting",
    Cust_CC_JobProfile = "successfactors.cust_CC_JobProfile",
    CompetencyContent = "successfactors.CompetencyContent",
    DevGoal_2002 = "successfactors.DevGoal_2002",
    Background_Fsaelection = "successfactors.Background_Fsaelection",
    CandidateProfileExtension = "successfactors.CandidateProfileExtension",
    TimeTypeDEU = "successfactors.TimeTypeDEU",
    EmployeeTimeMEX = "successfactors.EmployeeTimeMEX",
    CustomNav = "successfactors.CustomNav",
    PerEmergencyContacts = "successfactors.PerEmergencyContacts",
    RecurringDeduction = "successfactors.RecurringDeduction",
    FormRouteStep = "successfactors.FormRouteStep",
    EmpTimeAccountBalance = "successfactors.EmpTimeAccountBalance",
    PickListV2 = "successfactors.PickListV2",
    JobRequisitionAssessment = "successfactors.JobRequisitionAssessment",
    FOJobClassLocalCAN = "successfactors.FOJobClassLocalCAN",
    JobClassificationITA = "successfactors.JobClassificationITA",
    JDTemplateFamilyMapping = "successfactors.JDTemplateFamilyMapping",
    SuccessStoreContentBlob = "successfactors.SuccessStoreContentBlob",
    CandidateTags = "successfactors.CandidateTags",
    TimeAccountPayoutProfile = "successfactors.TimeAccountPayoutProfile",
    DGField = "successfactors.DGField",
    PaymentInformationDetailV3NZL = "successfactors.PaymentInformationDetailV3NZL",
    FormCompetencySection = "successfactors.FormCompetencySection",
    ThemeConfig = "successfactors.ThemeConfig",
    EmpCompensation = "successfactors.EmpCompensation",
    Holiday = "successfactors.Holiday",
    TeamGoal_1000 = "successfactors.TeamGoal_1000",
    SkillEntity = "successfactors.SkillEntity",
    ONB2Process = "successfactors.ONB2Process",
    WorkflowAllowedActionList = "successfactors.WorkflowAllowedActionList",
    JobAnalyzerReportingData = "successfactors.JobAnalyzerReportingData",
    EmployeeTime = "successfactors.EmployeeTime",
    CalibrationSessionParticipantsInfo = "successfactors.CalibrationSessionParticipantsInfo",
    EmpCostDistributionItem = "successfactors.EmpCostDistributionItem",
    FOLegalEntityLocalDEFLT = "successfactors.FOLegalEntityLocalDEFLT",
    TimeAccountPostingRule = "successfactors.TimeAccountPostingRule",
    MDFBlockConfig = "successfactors.MDFBlockConfig",
    Background_PreferredNextMove = "successfactors.Background_PreferredNextMove",
    Attachment = "successfactors.Attachment",
    RBPBasicPermission = "successfactors.RBPBasicPermission",
    ONB2DataCollectionUserConfig = "successfactors.ONB2DataCollectionUserConfig",
    GoalTaskPermission_3 = "successfactors.GoalTaskPermission_3",
    GoalTaskPermission_2 = "successfactors.GoalTaskPermission_2",
    FormRouteMap = "successfactors.FormRouteMap",
    PaymentInformationDetailV3ISR = "successfactors.PaymentInformationDetailV3ISR",
    CandidateBackground_Education = "successfactors.CandidateBackground_Education",
    EmployeeTimeGroupItem = "successfactors.EmployeeTimeGroupItem",
    Achievement = "successfactors.Achievement",
    Form360ParticipantSection = "successfactors.Form360ParticipantSection",
    InformationDataSubjectConfiguration = "successfactors.InformationDataSubjectConfiguration",
    EmpPayCompNonRecurring = "successfactors.EmpPayCompNonRecurring",
    Form360Participant = "successfactors.Form360Participant",
    Background_Benefitselection = "successfactors.Background_Benefitselection",
    EmploymentConditionContent = "successfactors.EmploymentConditionContent",
    Candidate = "successfactors.Candidate",
    FormCustomizedWeightedRatingSection = "successfactors.FormCustomizedWeightedRatingSection",
    CandidateBackground_OutsideWorkExperience = "successfactors.CandidateBackground_OutsideWorkExperience",
    JobApplicationOnboardingData = "successfactors.JobApplicationOnboardingData",
    FormSignatureSection = "successfactors.FormSignatureSection",
    FOJobClassLocalITA = "successfactors.FOJobClassLocalITA",
    PayPeriod = "successfactors.PayPeriod",
    FOPayRange = "successfactors.FOPayRange",
    Cust_CC_UserComp = "successfactors.cust_CC_UserComp",
    JobProfile = "successfactors.JobProfile",
    JobApplicationBackgroundCheckRequest = "successfactors.JobApplicationBackgroundCheckRequest",
    RoleTalentPoolMappingEntity = "successfactors.RoleTalentPoolMappingEntity",
    JobApplicationQuestionResponse = "successfactors.JobApplicationQuestionResponse",
    Cust_GERFeature = "successfactors.cust_GERFeature",
    Cust_GERTemplateVariables = "successfactors.cust_GERTemplateVariables",
    JobApplicationStatusAuditTrail = "successfactors.JobApplicationStatusAuditTrail",
    PaymentInformationDetailV3IRQ = "successfactors.PaymentInformationDetailV3IRQ",
    FOCostCenter = "successfactors.FOCostCenter",
    PicklistOption = "successfactors.PicklistOption",
    LocalizedData = "successfactors.LocalizedData",
    PerPerson = "successfactors.PerPerson",
    FormCompetency = "successfactors.FormCompetency",
    Cust_CC_AppProperties = "successfactors.cust_CC_AppProperties",
    Cust_CC_User = "successfactors.cust_CC_User",
    DevGoalPermission_2007 = "successfactors.DevGoalPermission_2007",
    UserRewardInfo = "successfactors.UserRewardInfo",
    ContinuousFeedbackRequest = "successfactors.ContinuousFeedbackRequest",
    DevGoalPermission_2006 = "successfactors.DevGoalPermission_2006",
    EmployeeProfilePageConfig = "successfactors.EmployeeProfilePageConfig",
    TemporaryTimeInformation = "successfactors.TemporaryTimeInformation",
    DGFilter = "successfactors.DGFilter",
    TimeTypeProfile = "successfactors.TimeTypeProfile",
    DevGoalPermission_2002 = "successfactors.DevGoalPermission_2002",
    WfRequestStep = "successfactors.WfRequestStep",
    PayScaleLevel = "successfactors.PayScaleLevel",
    HireDateChange = "successfactors.HireDateChange",
    FOPayComponentGroup = "successfactors.FOPayComponentGroup",
    MarketingBrand = "successfactors.MarketingBrand",
    PhysicalReqEntity = "successfactors.PhysicalReqEntity",
    Background_FuncExperience = "successfactors.Background_FuncExperience",
    InterviewQuestionEntity = "successfactors.InterviewQuestionEntity",
    FOCorporateAddressDEFLT = "successfactors.FOCorporateAddressDEFLT",
    BehaviorMappingEntity = "successfactors.BehaviorMappingEntity",
    WfRequestUIData = "successfactors.WfRequestUIData",
    FormBehaviorRatingComment = "successfactors.FormBehaviorRatingComment",
    CandidateBackground_Mobility = "successfactors.CandidateBackground_Mobility",
    PaymentInformationDetailV3ZWE = "successfactors.PaymentInformationDetailV3ZWE",
    EmployeeProfileHeaderConfig = "successfactors.EmployeeProfileHeaderConfig",
    Background_Certificates = "successfactors.Background_Certificates",
    EmployeeTimeNLD = "successfactors.EmployeeTimeNLD",
    PerGlobalInfoDNK = "successfactors.PerGlobalInfoDNK",
    CandidateProfileConversionInfo = "successfactors.CandidateProfileConversionInfo",
    PaymentInformationDetailV3ITA = "successfactors.PaymentInformationDetailV3ITA",
    FamilyEntity = "successfactors.FamilyEntity",
    EmpGlobalAssignment = "successfactors.EmpGlobalAssignment",
    EmployeeDataReplicationConfirmation = "successfactors.EmployeeDataReplicationConfirmation",
    PersonKey = "successfactors.PersonKey",
    EmployeeTimePOL = "successfactors.EmployeeTimePOL",
    Goal_999 = "successfactors.Goal_999",
    Goal_998 = "successfactors.Goal_998",
    Cust_GER_PersonnelSubArea = "successfactors.cust_GER_PersonnelSubArea",
    RCMAdminReassignOfferApprover = "successfactors.RCMAdminReassignOfferApprover",
    ContinuousPerformanceUserPermission = "successfactors.ContinuousPerformanceUserPermission",
    FOJobCode = "successfactors.FOJobCode",
    WorkSchedule = "successfactors.WorkSchedule",
    Background_Googledocs = "successfactors.Background_Googledocs",
    PaymentInformationDetailV3CHL = "successfactors.PaymentInformationDetailV3CHL",
    LegalEntityESP = "successfactors.LegalEntityESP",
    Cust_GEHTemplate = "successfactors.cust_GEHTemplate",
    LegalEntityUSA = "successfactors.LegalEntityUSA",
    PerSocialAccount = "successfactors.PerSocialAccount",
    Cust_Performancedata = "successfactors.cust_Performancedata",
    ONB2ProcessTask = "successfactors.ONB2ProcessTask",
    Background_SysScoreCardDevelopmentObjectivesPortlet = "successfactors.Background_SysScoreCardDevelopmentObjectivesPortlet",
    UserAccount = "successfactors.UserAccount",
    PayrollSystemConfiguration = "successfactors.PayrollSystemConfiguration",
    RoleSkillMappingEntity = "successfactors.RoleSkillMappingEntity",
    Cust_CC_UserFuncComp = "successfactors.cust_CC_UserFuncComp",
    FormObjectiveSection = "successfactors.FormObjectiveSection",
    DevGoalAchievementsList = "successfactors.DevGoalAchievementsList",
    PaymentInformationDetailV3GBR = "successfactors.PaymentInformationDetailV3GBR",
    EmployeeProfileSubSectionConfig = "successfactors.EmployeeProfileSubSectionConfig",
    FOLegalEntityLocalDEU = "successfactors.FOLegalEntityLocalDEU",
    HolidayAssignment = "successfactors.HolidayAssignment",
    CustomPayTypeAssignment = "successfactors.CustomPayTypeAssignment",
    Cust_GEHApplication = "successfactors.cust_GEHApplication",
    JobReqFwdCandidates = "successfactors.JobReqFwdCandidates",
    Cust_CC_FuncComp = "successfactors.cust_CC_FuncComp",
    FormReviewerInfoSection = "successfactors.FormReviewerInfoSection",
    DGExpression = "successfactors.DGExpression",
    WorkOrder = "successfactors.WorkOrder",
    FormIntroductionSection = "successfactors.FormIntroductionSection",
    PayScaleArea = "successfactors.PayScaleArea",
    SkillContent = "successfactors.SkillContent",
    FormObjective = "successfactors.FormObjective",
    FormObjectiveOtherDetails = "successfactors.FormObjectiveOtherDetails",
    Form360ParticipantColumn = "successfactors.Form360ParticipantColumn",
    JobApplicationSnapshot_Languages = "successfactors.JobApplicationSnapshot_Languages",
    EmpJobRelationships = "successfactors.EmpJobRelationships",
    AlertMessage = "successfactors.AlertMessage",
    FormPMReviewContentDetail = "successfactors.FormPMReviewContentDetail",
    ShiftClassification = "successfactors.ShiftClassification",
    DevLearning_4201 = "successfactors.DevLearning_4201",
    PaymentMethodV3 = "successfactors.PaymentMethodV3",
    Position = "successfactors.Position",
    FOLocationGroup = "successfactors.FOLocationGroup",
    FOJobClassLocalFRA = "successfactors.FOJobClassLocalFRA",
    JobApplicationAssessmentReport = "successfactors.JobApplicationAssessmentReport",
    TodoCategory = "successfactors.TodoCategory",
    HolidayCalendar = "successfactors.HolidayCalendar",
    SpotAwardCategory = "successfactors.SpotAwardCategory",
    CurrencyExchangeRate = "successfactors.CurrencyExchangeRate",
    PerGlobalInfoNLD = "successfactors.PerGlobalInfoNLD",
    Form360SummaryViewSection = "successfactors.Form360SummaryViewSection",
    GoalAchievements = "successfactors.GoalAchievements",
    JobReqTemplate_EZHire_Simplified = "successfactors.JobReqTemplate_EZHire_Simplified",
    Cust_LegalEntityBEL = "successfactors.cust_LegalEntityBEL",
    ComplianceDocumentFlow = "successfactors.ComplianceDocumentFlow",
    PerAddressDEFLT = "successfactors.PerAddressDEFLT",
    FormObjectiveOtherDetailsItemValueCell = "successfactors.FormObjectiveOtherDetailsItemValueCell",
    PerGlobalInfoARE = "successfactors.PerGlobalInfoARE",
    HolidayCategory = "successfactors.HolidayCategory",
    Form360ParticipantConfig = "successfactors.Form360ParticipantConfig",
    AdvancesEligibility = "successfactors.AdvancesEligibility",
    GoalPermission_999 = "successfactors.GoalPermission_999",
    RelevantIndustryContent = "successfactors.RelevantIndustryContent",
    PersonEmpTerminationInfo = "successfactors.PersonEmpTerminationInfo",
    ONB2ProcessTrigger = "successfactors.ONB2ProcessTrigger",
    GoalPermission_998 = "successfactors.GoalPermission_998",
    PerGlobalInfoSWE = "successfactors.PerGlobalInfoSWE",
    CandidateBackground_GlobalInfo = "successfactors.CandidateBackground_GlobalInfo",
    FormRouteSubStep = "successfactors.FormRouteSubStep",
    ActivityStatus = "successfactors.ActivityStatus",
    Background_VarPayEmpHistData = "successfactors.Background_VarPayEmpHistData",
    PerPersonRelationship = "successfactors.PerPersonRelationship",
    FormItemConfiguration = "successfactors.FormItemConfiguration",
    DeductionScreenId = "successfactors.DeductionScreenId",
    RcmCompetency = "successfactors.RcmCompetency",
    InitiativeAlignmentBean = "successfactors.InitiativeAlignmentBean",
    JobRequisition = "successfactors.JobRequisition",
    CandidateBackground_InsideWorkExperience = "successfactors.CandidateBackground_InsideWorkExperience",
    MentoringProgramParticipantInfo = "successfactors.MentoringProgramParticipantInfo",
    TalentPool = "successfactors.TalentPool",
    WorkScheduleDayModel = "successfactors.WorkScheduleDayModel",
    Goal_1 = "successfactors.Goal_1",
    Goal_3 = "successfactors.Goal_3",
    JobApplicationInterview = "successfactors.JobApplicationInterview",
    Goal_2 = "successfactors.Goal_2",
    Background_Documents = "successfactors.Background_Documents",
    Goal_5 = "successfactors.Goal_5",
    Goal_4 = "successfactors.Goal_4",
    Goal_6 = "successfactors.Goal_6",
    FormContent = "successfactors.FormContent",
    ExternalUser = "successfactors.ExternalUser",
    EMEventPayload = "successfactors.EMEventPayload",
    PaymentInformationDetailV3MOZ = "successfactors.PaymentInformationDetailV3MOZ",
    FOPayComponent = "successfactors.FOPayComponent",
    PaymentInformationV3 = "successfactors.PaymentInformationV3",
    GoalTask_2 = "successfactors.GoalTask_2",
    GoalTask_3 = "successfactors.GoalTask_3",
    EmployeeProfileFieldConfig = "successfactors.EmployeeProfileFieldConfig",
    OfferLetter = "successfactors.OfferLetter",
    FormJobRole = "successfactors.FormJobRole",
    SimpleGoal = "successfactors.SimpleGoal",
    JobApplicationAssessmentOrder = "successfactors.JobApplicationAssessmentOrder",
    JobClassificationUSA = "successfactors.JobClassificationUSA",
    PayrollDataMaintenanceTask = "successfactors.PayrollDataMaintenanceTask",
    JobReqScreeningQuestion = "successfactors.JobReqScreeningQuestion",
    Background_Awards = "successfactors.Background_Awards",
    AutoDelegateConfig = "successfactors.AutoDelegateConfig",
    SecondaryAssignments = "successfactors.SecondaryAssignments",
    ThemeInfo = "successfactors.ThemeInfo",
    JobRequisitionGroupOperator = "successfactors.JobRequisitionGroupOperator",
    DevGoalDetail = "successfactors.DevGoalDetail",
    FoTranslation = "successfactors.FoTranslation",
    CurrencyConversion = "successfactors.CurrencyConversion",
    JobReqFOLocation = "successfactors.JobReqFOLocation",
    TimeAccountPurchaseProfilePayComponentAssignment = "successfactors.TimeAccountPurchaseProfilePayComponentAssignment",
    RoleCompetencyBehaviorMappingEntity = "successfactors.RoleCompetencyBehaviorMappingEntity",
    FormReviewFeedback = "successfactors.FormReviewFeedback",
    JobApplicationBackgroundCheckResult = "successfactors.JobApplicationBackgroundCheckResult",
    SpotAwardBudget = "successfactors.SpotAwardBudget",
    FOJobClassLocalUSA = "successfactors.FOJobClassLocalUSA",
    WorkScheduleDayModelAssignment = "successfactors.WorkScheduleDayModelAssignment",
    JobApplicationAudit = "successfactors.JobApplicationAudit",
    Cust_CC_UserCompDocument = "successfactors.cust_CC_UserCompDocument",
    GoalPlanTemplate = "successfactors.GoalPlanTemplate",
    FormFolder = "successfactors.FormFolder",
    CPMNotificationConfig = "successfactors.CPMNotificationConfig",
    AssignedComplianceForm = "successfactors.AssignedComplianceForm",
    Cust_GER_PersonnelArea = "successfactors.cust_GER_PersonnelArea",
    WorkScheduleDay = "successfactors.WorkScheduleDay",
    MyPendingWorkflow = "successfactors.MyPendingWorkflow",
    CalibrationSubjectComment = "successfactors.CalibrationSubjectComment",
    TimeAccount = "successfactors.TimeAccount",
    ComplianceFormSignature = "successfactors.ComplianceFormSignature",
    EmployeeTimeCOL = "successfactors.EmployeeTimeCOL",
    RecurringDeductionItem = "successfactors.RecurringDeductionItem",
    EducationDegreeEntity = "successfactors.EducationDegreeEntity",
    EmployeeTimeESP = "successfactors.EmployeeTimeESP",
    Background_OutsideWorkExperience = "successfactors.Background_OutsideWorkExperience",
    AchievementDevGoalDetail = "successfactors.AchievementDevGoalDetail",
    SpotAwardGuidelinesRule = "successfactors.SpotAwardGuidelinesRule",
    EmployeeTimeUSA = "successfactors.EmployeeTimeUSA",
    Form360SummaryViewCategory = "successfactors.Form360SummaryViewCategory",
    MDFLocalizedValue = "successfactors.MDFLocalizedValue",
    FOLocation = "successfactors.FOLocation",
    FOWfConfig = "successfactors.FOWfConfig",
    Background_Courses = "successfactors.Background_Courses",
    MDFTenantPreferredTimeZone = "successfactors.MDFTenantPreferredTimeZone",
    DGPeoplePool = "successfactors.DGPeoplePool",
    PayrollDataMaintenanceTaskConfiguration = "successfactors.PayrollDataMaintenanceTaskConfiguration",
    RBPRule = "successfactors.RBPRule",
    SAPSystemConfiguration = "successfactors.SAPSystemConfiguration",
    JobReqTemplate_Hiring_Requisition_with_Position = "successfactors.JobReqTemplate_Hiring_Requisition_with_Position",
    JobResponsibilityContent = "successfactors.JobResponsibilityContent",
    FormTemplate = "successfactors.FormTemplate",
    Cust_GERReqTempl = "successfactors.cust_GERReqTempl",
    GoalMilestonePermission_3 = "successfactors.GoalMilestonePermission_3",
    CompetencyType = "successfactors.CompetencyType",
    JobOfferApprover = "successfactors.JobOfferApprover",
    ONB2BuddyActivity = "successfactors.ONB2BuddyActivity",
    BudgetGroup = "successfactors.BudgetGroup",
    RatedSkillMapping = "successfactors.RatedSkillMapping",
    ONB2EquipmentType = "successfactors.ONB2EquipmentType",
    UserPermissions = "successfactors.UserPermissions",
    JobApplicationFieldControls = "successfactors.JobApplicationFieldControls",
    LegalEntityRUS = "successfactors.LegalEntityRUS",
    Cust_GERReqTemplField = "successfactors.cust_GERReqTemplField",
    JobClassificationFRA = "successfactors.JobClassificationFRA",
    PaymentInformationDetailV3ECU = "successfactors.PaymentInformationDetailV3ECU",
    PaymentMethodAssignmentV3 = "successfactors.PaymentMethodAssignmentV3",
    GoalMilestonePermission_2 = "successfactors.GoalMilestonePermission_2",
    FormAuditTrail = "successfactors.FormAuditTrail",
    PaymentInformationDetailV3VEN = "successfactors.PaymentInformationDetailV3VEN",
    DevGoalEnum = "successfactors.DevGoalEnum",
    PaymentInformationDetailV3GHA = "successfactors.PaymentInformationDetailV3GHA",
    SpotAwardProgram = "successfactors.SpotAwardProgram",
    EmployeeDataReplicationNotification = "successfactors.EmployeeDataReplicationNotification",
    FOJobClassLocalDEFLT = "successfactors.FOJobClassLocalDEFLT",
    Background_Education = "successfactors.Background_Education",
    ThemeTemplate = "successfactors.ThemeTemplate",
    ExtAddressInfo = "successfactors.ExtAddressInfo",
    MentoringProgram = "successfactors.MentoringProgram",
    FormCompetencyBehavior = "successfactors.FormCompetencyBehavior",
    CalibrationTemplate = "successfactors.CalibrationTemplate",
    FOLegalEntityLocalFRA = "successfactors.FOLegalEntityLocalFRA",
    JobApplicationSnapshot_GlobalInfo = "successfactors.JobApplicationSnapshot_GlobalInfo",
    EmpJob = "successfactors.EmpJob",
    Activity = "successfactors.Activity",
    InterviewIndividualAssessment = "successfactors.InterviewIndividualAssessment",
    JobOfferTemplate_Offer_Detail_Template = "successfactors.JobOfferTemplate_Offer_Detail_Template",
    FOBusinessUnit = "successfactors.FOBusinessUnit",
    PickListValueV2 = "successfactors.PickListValueV2",
    JobClassificationAUS = "successfactors.JobClassificationAUS",
    GoalAchievementsList = "successfactors.GoalAchievementsList",
    DigitalSupportIncident = "successfactors.DigitalSupportIncident",
    JobOffer = "successfactors.JobOffer",
    Cust_CC_ProfileAssignment = "successfactors.cust_CC_ProfileAssignment",
    FOEventReason = "successfactors.FOEventReason",
    Currency = "successfactors.Currency",
    FormJobDescSection = "successfactors.FormJobDescSection",
    TimeAccountDetail = "successfactors.TimeAccountDetail",
    VendorInfo = "successfactors.VendorInfo",
    TalentGraphicOption = "successfactors.TalentGraphicOption",
    DevGoalAchievements = "successfactors.DevGoalAchievements",
    PaymentInformationDetailV3TUN = "successfactors.PaymentInformationDetailV3TUN",
    Cust_CC_RatingExplanation = "successfactors.cust_CC_RatingExplanation",
    FormObjectiveOtherDetailsItemCol = "successfactors.FormObjectiveOtherDetailsItemCol",
    AchievementGoalDetail = "successfactors.AchievementGoalDetail",
    Cust_GERReqTemplOperator = "successfactors.cust_GERReqTemplOperator",
    EmployeeDataReplicationConfirmationErrorMessage = "successfactors.EmployeeDataReplicationConfirmationErrorMessage",
    PaymentInformationDetailV3BRA = "successfactors.PaymentInformationDetailV3BRA",
    EPPublicProfile = "successfactors.EPPublicProfile",
    JobRequisitionOperator = "successfactors.JobRequisitionOperator",
    FOJobClassLocalBRA = "successfactors.FOJobClassLocalBRA",
    EducationMajorEntity = "successfactors.EducationMajorEntity",
    PerPhone = "successfactors.PerPhone",
    JobOfferFieldControls = "successfactors.JobOfferFieldControls",
    EmpPayCompRecurring = "successfactors.EmpPayCompRecurring",
    FormPerfPotSummarySection = "successfactors.FormPerfPotSummarySection",
    GoalPermission_1000 = "successfactors.GoalPermission_1000",
    PayrollDataMaintenanceTaskTypeConfiguration = "successfactors.PayrollDataMaintenanceTaskTypeConfiguration",
    EmployeeTimeDEU = "successfactors.EmployeeTimeDEU",
    PaymentInformationDetailV3MEX = "successfactors.PaymentInformationDetailV3MEX",
    EducationMajorContent = "successfactors.EducationMajorContent",
    ONB2EquipmentTypeValue = "successfactors.ONB2EquipmentTypeValue",
    Form360ReviewContentDetail = "successfactors.Form360ReviewContentDetail",
    DGFieldValue = "successfactors.DGFieldValue",
    ActivityFeedback = "successfactors.ActivityFeedback",
    ElectronicSicknessCertificateExclusionReasonDEU = "successfactors.ElectronicSicknessCertificateExclusionReasonDEU",
    GoalWeight = "successfactors.GoalWeight",
    EmpWorkPermit = "successfactors.EmpWorkPermit",
    FormHeader = "successfactors.FormHeader",
    FormCustomElementListValue = "successfactors.FormCustomElementListValue",
    FormCustomSection = "successfactors.FormCustomSection",
    Bank = "successfactors.Bank",
    MentoringProgramMatchedParticipant = "successfactors.MentoringProgramMatchedParticipant",
    Background_Languages = "successfactors.Background_Languages",
    InterviewQuestionContent = "successfactors.InterviewQuestionContent",
    FormSignature = "successfactors.FormSignature",
    CompetencyEntity = "successfactors.CompetencyEntity",
    JobApplicationInterviewFieldControls = "successfactors.JobApplicationInterviewFieldControls",
    EPCustomBackgroundPortlet = "successfactors.EPCustomBackgroundPortlet",
    FeedbackFlag = "successfactors.FeedbackFlag",
    FormUserRatingComment = "successfactors.FormUserRatingComment",
    PersonTypeUsage = "successfactors.PersonTypeUsage",
    RBPRole = "successfactors.RBPRole",
    FODivision = "successfactors.FODivision",
    CertificationEntity = "successfactors.CertificationEntity",
    PaymentInformationDetailV3SUR = "successfactors.PaymentInformationDetailV3SUR",
    DigitalSupportSystemInformation = "successfactors.DigitalSupportSystemInformation",
    WfRequestComments = "successfactors.WfRequestComments",
    EmployeeTimeCAN = "successfactors.EmployeeTimeCAN",
    EmployeePayrollRunResults = "successfactors.EmployeePayrollRunResults",
    CustomPayType = "successfactors.CustomPayType",
    FOCompany = "successfactors.FOCompany",
    EmployeeDataReplicationElement = "successfactors.EmployeeDataReplicationElement",
    PaymentInformationDetailV3ZAF = "successfactors.PaymentInformationDetailV3ZAF",
    LegalEntityDEU = "successfactors.LegalEntityDEU",
    JobApplicationAssessmentReportDetail = "successfactors.JobApplicationAssessmentReportDetail",
    Form360SummaryViewRater = "successfactors.Form360SummaryViewRater",
    EmpEmployment = "successfactors.EmpEmployment",
    CompetencyRating = "successfactors.CompetencyRating",
    JobApplicationStatus = "successfactors.JobApplicationStatus",
    InlineResult = "successfactors.InlineResult",
    PayScaleGroup = "successfactors.PayScaleGroup",
    ExtPersonalInfo = "successfactors.ExtPersonalInfo",
    FODepartment = "successfactors.FODepartment",
    FormSummarySection = "successfactors.FormSummarySection",
    FormRaterListSection = "successfactors.FormRaterListSection",
    Background_SpecialAssign = "successfactors.Background_SpecialAssign",
    JobApplicationOnboardingStatus = "successfactors.JobApplicationOnboardingStatus",
    SpotAwardRedemption = "successfactors.SpotAwardRedemption",
    DynamicGroup = "successfactors.DynamicGroup",
    SecondaryAssignmentsItem = "successfactors.SecondaryAssignmentsItem",
    Cust_CC_Group = "successfactors.cust_CC_Group",
    PayrollDataMaintenanceTaskTypeLinkConfiguration = "successfactors.PayrollDataMaintenanceTaskTypeLinkConfiguration",
    JobRequisitionFieldControls = "successfactors.JobRequisitionFieldControls",
    Photo = "successfactors.Photo",
    JobCodeMappingEntity = "successfactors.JobCodeMappingEntity",
    FOLegalEntityLocalUSA = "successfactors.FOLegalEntityLocalUSA",
    PaymentInformationDetailV3MKD = "successfactors.PaymentInformationDetailV3MKD",
    FOLegalEntityLocalESP = "successfactors.FOLegalEntityLocalESP",
    CalibrationSubjectRank = "successfactors.CalibrationSubjectRank",
    OnboardingInfo = "successfactors.OnboardingInfo",
    Cust_GERBrand = "successfactors.cust_GERBrand",
    PositionSkillMappingEntity = "successfactors.PositionSkillMappingEntity",
    JobRequisitionLocaleFieldControls = "successfactors.JobRequisitionLocaleFieldControls",
    PerGlobalInfoPRT = "successfactors.PerGlobalInfoPRT",
    FamilyCompetencyMappingEntity = "successfactors.FamilyCompetencyMappingEntity",
    JobApplicationSnapshot_Education = "successfactors.JobApplicationSnapshot_Education",
    FormObjCompSummarySection = "successfactors.FormObjCompSummarySection",
    FOPayGrade = "successfactors.FOPayGrade",
    JobProfileLocalizedData = "successfactors.JobProfileLocalizedData",
    PaymentInformationDetailV3ARG = "successfactors.PaymentInformationDetailV3ARG",
    AbsenceCountingMethod = "successfactors.AbsenceCountingMethod",
    PaymentInformationDetailV3KEN = "successfactors.PaymentInformationDetailV3KEN",
    Territory = "successfactors.Territory",
    ExternalLearner = "successfactors.ExternalLearner",
    CertificationContent = "successfactors.CertificationContent",
    PerGlobalInfoNOR = "successfactors.PerGlobalInfoNOR",
    EMEventAttribute = "successfactors.EMEventAttribute",
    Cust_GER_PersonnelUnit = "successfactors.cust_GER_PersonnelUnit",
    PaymentInformationDetailV3SVN = "successfactors.PaymentInformationDetailV3SVN",
    SpotAwardRedemptionProduct = "successfactors.SpotAwardRedemptionProduct",
    PaymentInformationDetailV3SVK = "successfactors.PaymentInformationDetailV3SVK",
    CandidateEmployeeReferral = "successfactors.CandidateEmployeeReferral",
    NonRecurringPayment = "successfactors.NonRecurringPayment",
    TrendData_SysOverallPerformance = "successfactors.TrendData_SysOverallPerformance",
    SuccessStoreContent = "successfactors.SuccessStoreContent",
    MDFEnumValue = "successfactors.MDFEnumValue",
    AccrualCalculationBase = "successfactors.AccrualCalculationBase",
    SpotAwardRedemptionOrder = "successfactors.SpotAwardRedemptionOrder",
    PaymentInformationDetailV3 = "successfactors.PaymentInformationDetailV3",
    TimeTypeUSA = "successfactors.TimeTypeUSA",
    PaymentInformationDetailV3PRY = "successfactors.PaymentInformationDetailV3PRY",
    Background_Compensation = "successfactors.Background_Compensation",
    JobAppTemplate_EZHire_Simplified_Candidate_Detail_Info_Template = "successfactors.JobAppTemplate_EZHire_Simplified_Candidate_Detail_Info_Template",
    FOGeozone = "successfactors.FOGeozone",
    Form360ParticipantCategory = "successfactors.Form360ParticipantCategory",
    JobReqScreeningQuestionChoice = "successfactors.JobReqScreeningQuestionChoice",
    SkillProfile = "successfactors.SkillProfile",
    WfRequestParticipator = "successfactors.WfRequestParticipator",
    Successor = "successfactors.Successor",
    TimeAccountSnapshot = "successfactors.TimeAccountSnapshot",
    Form360Rater = "successfactors.Form360Rater",
    TeamGoalOwner = "successfactors.TeamGoalOwner",
    PaymentInformationDetailV3CZE = "successfactors.PaymentInformationDetailV3CZE",
    PerGlobalInfoGBR = "successfactors.PerGlobalInfoGBR",
    JobDescTemplate = "successfactors.JobDescTemplate",
    PaymentInformationDetailV3MMR = "successfactors.PaymentInformationDetailV3MMR",
    DevGoalPlanTemplate = "successfactors.DevGoalPlanTemplate",
    ComplianceProcessTask = "successfactors.ComplianceProcessTask",
    Cust_CC_ProfileComp = "successfactors.cust_CC_ProfileComp",
    AdvancesAccumulation = "successfactors.AdvancesAccumulation",
    GoalPermission_5 = "successfactors.GoalPermission_5",
    GoalPermission_6 = "successfactors.GoalPermission_6",
    GoalPermission_3 = "successfactors.GoalPermission_3",
    GoalPermission_4 = "successfactors.GoalPermission_4",
    GoalPermission_1 = "successfactors.GoalPermission_1",
    FOFrequency = "successfactors.FOFrequency",
    TimeAccountTypeAUS = "successfactors.TimeAccountTypeAUS",
    GoalPermission_2 = "successfactors.GoalPermission_2",
    EducationDegreeContent = "successfactors.EducationDegreeContent",
    GoalPlanState = "successfactors.GoalPlanState",
    AvailableTimeType = "successfactors.AvailableTimeType",
    JobClassificationZAF = "successfactors.JobClassificationZAF",
    ExternalLearnerAddressInfo = "successfactors.ExternalLearnerAddressInfo",
    DevGoalCompetency = "successfactors.DevGoalCompetency",
    AdvancesInstallments = "successfactors.AdvancesInstallments",
    Cust_CC_Task = "successfactors.cust_CC_Task",
    EmploymentConditionEntity = "successfactors.EmploymentConditionEntity",
    JobClassificationBRA = "successfactors.JobClassificationBRA",
    PositionMatrixRelationship = "successfactors.PositionMatrixRelationship",
    FormReviewInfoSection = "successfactors.FormReviewInfoSection",
    Background_Promotability = "successfactors.Background_Promotability",
    PerNationalId = "successfactors.PerNationalId",
    ReplicationTargetSystem = "successfactors.ReplicationTargetSystem",
    FormObjectiveOtherDetailsItem = "successfactors.FormObjectiveOtherDetailsItem",
    TimeAccountPurchaseProfile = "successfactors.TimeAccountPurchaseProfile",
    PersonType = "successfactors.PersonType",
    DomainEventAlert = "successfactors.DomainEventAlert",
    Cust_CC_Competency = "successfactors.cust_CC_Competency",
    RoleEntity = "successfactors.RoleEntity",
    Cust_CC_Classification = "successfactors.cust_CC_Classification",
    FormObjectiveDetails = "successfactors.FormObjectiveDetails",
    JobDescSection = "successfactors.JobDescSection",
    GoalMilestone_3 = "successfactors.GoalMilestone_3",
    FOJobClassLocalGBR = "successfactors.FOJobClassLocalGBR",
    PayrollConfigurationCategoryLink = "successfactors.PayrollConfigurationCategoryLink",
    GoalMilestone_2 = "successfactors.GoalMilestone_2",
    EmpWfRequest = "successfactors.EmpWfRequest",
    FormRatingScale = "successfactors.FormRatingScale",
    WfRequest = "successfactors.WfRequest",
    ComplianceProcess = "successfactors.ComplianceProcess",
    PerEmail = "successfactors.PerEmail",
    PerGlobalInfoIRL = "successfactors.PerGlobalInfoIRL",
    PositionEntity = "successfactors.PositionEntity",
    JobApplicationSnapshot_OutsideWorkExperience = "successfactors.JobApplicationSnapshot_OutsideWorkExperience",
    CandidateBackground_Languages = "successfactors.CandidateBackground_Languages",
    Cust_CC_UserTask = "successfactors.cust_CC_UserTask",
    AutoDelegateDetail = "successfactors.AutoDelegateDetail",
    CalibrationSession = "successfactors.CalibrationSession",
    Form360RaterSection = "successfactors.Form360RaterSection",
    EmployeePayrollRunResultsItems = "successfactors.EmployeePayrollRunResultsItems",
    Country = "successfactors.Country",
    EmployeeTimeGroup = "successfactors.EmployeeTimeGroup",
    PayCalendar = "successfactors.PayCalendar",
    FormCustomElement = "successfactors.FormCustomElement",
    JobClassificationCAN = "successfactors.JobClassificationCAN",
    JobApplicationComments = "successfactors.JobApplicationComments",
    FormObjectiveComment = "successfactors.FormObjectiveComment",
    FOLegalEntityLocalARG = "successfactors.FOLegalEntityLocalARG",
    ExtPhoneInfo = "successfactors.ExtPhoneInfo",
    FOJobClassLocalAUS = "successfactors.FOJobClassLocalAUS",
    PositionRightToReturn = "successfactors.PositionRightToReturn",
    EmpCompensationCalculated = "successfactors.EmpCompensationCalculated",
    PositionCompetencyMappingEntity = "successfactors.PositionCompetencyMappingEntity",
    Background_Community = "successfactors.Background_Community",
    PaymentInformationDetailV3FRA = "successfactors.PaymentInformationDetailV3FRA",
    PaymentInformationDetailV3NAM = "successfactors.PaymentInformationDetailV3NAM",
    Cust_CC_VariantSearch = "successfactors.cust_CC_VariantSearch",
    ComplianceFormDataFieldValue = "successfactors.ComplianceFormDataFieldValue",
    PaymentInformationDetailV3PER = "successfactors.PaymentInformationDetailV3PER",
    LegalEntityFRA = "successfactors.LegalEntityFRA",
    ComplianceUserFormData = "successfactors.ComplianceUserFormData",
    FODynamicRole = "successfactors.FODynamicRole",
    ONB2EquipmentActivity = "successfactors.ONB2EquipmentActivity",
    EmployeeTimeAUS = "successfactors.EmployeeTimeAUS",
    FamilySkillMappingEntity = "successfactors.FamilySkillMappingEntity",
    PerPersonal = "successfactors.PerPersonal",
    Cust_CC_SolutionRoleGroupConfig = "successfactors.cust_CC_SolutionRoleGroupConfig",
    EmployeeTimeCalendar = "successfactors.EmployeeTimeCalendar",
    MessageDetail = "successfactors.MessageDetail",
    JobReqQuestion = "successfactors.JobReqQuestion",
    Form360ParticipantDetail = "successfactors.Form360ParticipantDetail",
    DRTMPurgeFreeze = "successfactors.DRTMPurgeFreeze",
    Background_LeadExperience = "successfactors.Background_LeadExperience",
    EmpCostDistribution = "successfactors.EmpCostDistribution",
    SpotAwardEligibilityRule = "successfactors.SpotAwardEligibilityRule",
    JobApplication = "successfactors.JobApplication",
    JobApplicationSnapshot_InsideWorkExperience = "successfactors.JobApplicationSnapshot_InsideWorkExperience",
    TrendData_SysOverallObjective = "successfactors.TrendData_SysOverallObjective",
    DGFieldOperator = "successfactors.DGFieldOperator",
    GoalMetricLookupPermission_5 = "successfactors.GoalMetricLookupPermission_5",
    PaymentInformationDetailV3ESP = "successfactors.PaymentInformationDetailV3ESP",
    RelevantIndustryEntity = "successfactors.RelevantIndustryEntity",
    PaymentInformationDetailV3USA = "successfactors.PaymentInformationDetailV3USA",
    Picklist = "successfactors.Picklist",
    PaymentInformationDetailV3COL = "successfactors.PaymentInformationDetailV3COL",
    GoalMetricLookupPermission_4 = "successfactors.GoalMetricLookupPermission_4",
    TrendData_SysOverallCompetency = "successfactors.TrendData_SysOverallCompetency",
    NomineeHistory = "successfactors.NomineeHistory",
    ContinuousFeedback = "successfactors.ContinuousFeedback",
    PayScaleType = "successfactors.PayScaleType",
    Background_Mobility = "successfactors.Background_Mobility",
    TimeTypeNLD = "successfactors.TimeTypeNLD",
    Goal_1000 = "successfactors.Goal_1000",
    LegacyPositionEntity = "successfactors.LegacyPositionEntity",
    Advance = "successfactors.Advance",
    EMEvent = "successfactors.EMEvent",
    Cust_GEH_templateField = "successfactors.cust_GEH_templateField",
    JobResponsibilityEntity = "successfactors.JobResponsibilityEntity",
    PerGlobalInfoSAU = "successfactors.PerGlobalInfoSAU",
    Background_VarPayEmpHistData_GPS = "successfactors.Background_VarPayEmpHistData_GPS",
    DataReplicationProxy = "successfactors.DataReplicationProxy",
    ExternalLearnerEmailInfo = "successfactors.ExternalLearnerEmailInfo",
    JobReqGOPosition = "successfactors.JobReqGOPosition",
    ComplianceFormData = "successfactors.ComplianceFormData",
    WorkScheduleDayModelAssignmentSegment = "successfactors.WorkScheduleDayModelAssignmentSegment",
    Background_Memberships = "successfactors.Background_Memberships",
    JobApplicationSnapshot_Mobility = "successfactors.JobApplicationSnapshot_Mobility",
    PaymentInformationDetailV3BLR = "successfactors.PaymentInformationDetailV3BLR",
    RightToReturn = "successfactors.RightToReturn",
    JobClassificationCountry = "successfactors.JobClassificationCountry",
    TalentRatings = "successfactors.TalentRatings",
    User = "successfactors.User",
    Cust_GERApplication = "successfactors.cust_GERApplication",
    FOPayGroup = "successfactors.FOPayGroup",
    JobClassificationGBR = "successfactors.JobClassificationGBR",
    FormUserInformationSection = "successfactors.FormUserInformationSection",
    PaymentInformationDetailV3BOL = "successfactors.PaymentInformationDetailV3BOL",
    TimeManagementAlert = "successfactors.TimeManagementAlert",
    PerGlobalInfoFIN = "successfactors.PerGlobalInfoFIN",
    TimeType = "successfactors.TimeType",
    Cust_GERConfig = "successfactors.cust_GERConfig",
    CandidateComments = "successfactors.CandidateComments",
    TodoEntryV3 = "successfactors.TodoEntryV3",
    FormSectionConfiguration = "successfactors.FormSectionConfiguration",
    TodoEntryV2 = "successfactors.TodoEntryV2",
    JobReqTemplate_EZHireTemplate = "successfactors.JobReqTemplate_EZHireTemplate",
    PaymentInformationDetailV3NGA = "successfactors.PaymentInformationDetailV3NGA",
    RoleCompetencyMappingEntity = "successfactors.RoleCompetencyMappingEntity",
    FOJobFunction = "successfactors.FOJobFunction",
    SpotAwardLevel = "successfactors.SpotAwardLevel",
    TimeManagementAlertMessage = "successfactors.TimeManagementAlertMessage",
    EmpCompensationGroupSumCalculated = "successfactors.EmpCompensationGroupSumCalculated",
    Cust_compensationEligibility = "successfactors.cust_compensationEligibility",
    JobAppTemplate_Candidate_Detail_Info_Template = "successfactors.JobAppTemplate_Candidate_Detail_Info_Template",
    CandidateLight = "successfactors.CandidateLight",
    GoalMetricLookup_4 = "successfactors.GoalMetricLookup_4",
    HRISChangeLogDataReplication = "successfactors.HRISChangeLogDataReplication",
    GoalMetricLookup_5 = "successfactors.GoalMetricLookup_5",
    WorkScheduleDayModelSegment = "successfactors.WorkScheduleDayModelSegment",
    EMMonitoredProcess = "successfactors.EMMonitoredProcess",
    FormReviewFeedbackList = "successfactors.FormReviewFeedbackList",
    PerGlobalInfoDEU = "successfactors.PerGlobalInfoDEU",
    TimeTypeAUS = "successfactors.TimeTypeAUS",
    NominationTarget = "successfactors.NominationTarget"
}
