...
/**
 * @namespace com.gavdilabs.ui5template
 */
export default class Component extends UIComponent {
  ...
  public init(): void {
    ...
    //Fill mock target granting
    this.fillTargetAndGranting();
  }
  ...
  private fillTargetAndGranting() {
    this.setModel(
      new JSONModel([
        {
          grant: "HR masterdata",
          target: "Hiring Managers HQ",
        },
        {
          grant: "Managers in Denmark",
          target: "Managers Direct Reports",
        },
      ]),
      "GrantingTarget"
    );
